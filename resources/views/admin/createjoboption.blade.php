     ...
     <div class="col-xs-12 effect-content" style="padding: 0px;"  >
            ...
            <div class="panel " >
                <section >
                    ...
                    <form method="POST" action="/dashboard/joboption/create" >
                      @csrf
                       ...
                       <div class="col-xs-12" style="padding: 0px;overflow: auto;">
                            <div class="col-xs-12 col-sm-6" style="padding-top: 50px;padding-bottom: 30px;">
                              ...
                              <div class="col-xs-12" style="padding-top: 15px">
                                ...
                                <div class="col-xs-9"> 
                                  <div class="col-xs-10">
                                    <textarea type="" name="details" class="form-control" style="border-radius: 0px;box-shadow: none;max-width: 100%;min-width: 100%;min-height: 250px;"></textarea>
                                  </div>
                                </div>
                              </div>
