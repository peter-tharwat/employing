...
<body >
	...
	<header class="navbar" id="header">
		<ul class="nav navbar-nav navbar-avatar pull-right hidden-xs" style="float: left!important;">
			...
			<h4 style="padding: 0px; margin: 0px;font-weight: bolder" class="h3">توظيف</h4></a> 
	...
	<nav class="nav-primary hidden-xs nav-vertical" id="nav" style="right:0px;"   >
		<ul class="nav" data-offset-top="50" data-spy="affix" >
			...
			<li class="dropdown-submenu">
				<a href="#">
					<i class="fa fa fa-user fa-lg"></i> <span>المسجلين</span>
				</a>
				<ul class="dropdown-menu">
				 
					<li>
						<a href="/dashboard/user">قائمة المسجلين</a>
					</li>
			...
			<li class="dropdown-submenu">
				<a href="#">
					<i class="fa   fa-user-tie fa-lg"></i> <span>المتقدمين</span>
				</a>
				<ul class="dropdown-menu">
				 
					<li>
						<a href="/dashboard/applicants"><!-- <b class="badge pull-right">302</b --> قائمة المتقدمين</a>
					</li>
			...
			<li class="dropdown-submenu">
				<a href="#">
					<i class="fas fa-user-md fa-lg"></i> <span>الوظائف</span>
				</a>
				<ul class="dropdown-menu">
					<li>
						<a href="/dashboard/job/create">اضافة وظيفة</a>
					</li>
					<li>
						<a href="/dashboard/job">قائمة الوظائف</a>
					</li>
					<li>
						<a href="/dashboard/joboption/create">اضافة نوع فرص</a>
					</li>
					<li>
						<a href="/dashboard/joboption">عرض انواع الفرص</a>
					</li>
