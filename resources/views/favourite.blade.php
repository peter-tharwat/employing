...
<div class="col-xs-12" style="height: 300px;">
    <div class="container">
      ...
      <?php 
      $loves=\App\Love::where('user_id',\Auth::user()->id)->get(); 
      $ids=array();
      foreach($loves as $myloves)
      {
        array_push($ids, $myloves->job_id);
      }
              ...
              <div class="modal-dialog modal-lg">
                <div class="modal-content" style="border-radius: 0px;">
                  ...
                  <div class="col-xs-12" style="padding: 0px 10px 20px;">
                    ...
                    @guest
                    @else
                    <form method="POST" action="/appling" id="appling_form">
                      @csrf
                      <input type="hidden" name="id" value="{{$myjob->id}}">
                      <button type="button" class="btn btn-default" onclick="$('#appling_form').submit();">مواصلة</button>
                    </form>
                    @endguest
