...
<div class="col-xs-12" style="height: 300px;">
    <div class="container">
      ...
      <?php 
      $application=\App\Application::where('user_id',\Auth::user()->id)->get(); 

      $ids=array();
      foreach($application as $myapplication)
      {
        array_push($ids, $myapplication->job_id);
      }
      $job=\App\Job::whereIn('id',$ids)->get();
      ...
      ?>
        ...
        <div style="color: #fff ;background:#fff;border-radius: 10px; min-height: 120px;padding: 0px;box-shadow: 0px 0px 10px #ccc;margin-top: 15px;position: relative;" class="col-xs-12" >
                ...
                <div style="position: absolute;bottom: 0px;width: 150px;height: 35px;background: #66c4a6;left: 0px;border-bottom-left-radius: inherit;color: #fff;padding: 5px;cursor: pointer;" class="text-center applying"  data-target="#myModal{{$myjob->id}}" data-toggle="modal"> 
                ...
                <div class="modal-content" style="border-radius: 0px;">
                  ...
                  <div class="col-xs-12" style="padding: 0px 10px 20px;">
                     ...
                     <div class="col-xs-12 col-md-8">
                       <div class="col-xs-3 text-left" style="color: #333">
                         الحالة
                       </div>
                     ...
                     <div class="col-xs-12 col-md-8">
                       ...
                       <div class="col-xs-9 text-right" style="color: #333">
                         يرجي العلم انه لم يتم مشاهدة الوظيفة حتي الآن
                       </div>
